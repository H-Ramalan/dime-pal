...
class CategoriesExpensesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categories_expense" do
    assert_difference("CategoriesExpense.count") do
      post categories_expenses_url, params: { categories_expense: { categories_id: @categories_expense.categories_id, expenses_id: @categories_expense.expenses_id } }
    end
  ...
  test "should update categories_expense" do
    patch categories_expense_url(@categories_expense), params: { categories_expense: { categories_id: @categories_expense.categories_id, expenses_id: @categories_expense.expenses_id } }
